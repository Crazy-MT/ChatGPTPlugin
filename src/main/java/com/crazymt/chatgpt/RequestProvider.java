...
public class RequestProvider {
    ...
    public RequestProvider createFree(MainPanel mainPanel, String question, String oaiDeviceId, String token) {
        ...
        provider.data = buildGpt35TurboFree(mainPanel.getProject(), question).toString();
        return provider;
    }
    ...
    public static JsonObject buildGpt35TurboFree(Project project, String text) {
